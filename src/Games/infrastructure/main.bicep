...
param serviceName string = 'games'
...
module gamesService 'service.bicep' = {
  scope: resourceGroup
  name: 'games-service-deployment'
  params: {
...
output containerAppName string = gamesService.outputs.containerAppName
output containerAppFqdn string = gamesService.outputs.containerAppFqdn
output resourceGroupName string = resourceGroupName
output cosmosDbAccountName string = gamesService.outputs.cosmosDbAccountName
output cosmosDbDatabaseName string = gamesService.outputs.cosmosDbDatabaseName
