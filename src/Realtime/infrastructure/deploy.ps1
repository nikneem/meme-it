# Deploy Realtime Service to Azure Container Apps
...
Write-Host "Deploying Realtime Service..." -ForegroundColor Cyan
...
$deploymentName = "memeit-realtime-$(Get-Date -Format 'yyyyMMdd-HHmmss')"
...
if ($WhatIf) {
    ...
    Write-Host "Deploying Realtime service..." -ForegroundColor Yellow
    ...
    if ($LASTEXITCODE -eq 0) {
        Write-Host ""
        Write-Host "SUCCESS: Realtime service deployed!" -ForegroundColor Green
        Write-Host ""
