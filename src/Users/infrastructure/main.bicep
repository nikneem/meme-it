...
module usersService 'service.bicep' = {
  scope: resourceGroup
...
output containerAppName string = usersService.outputs.containerAppName
output containerAppFqdn string = usersService.outputs.containerAppFqdn
